...
# bmad-bmm-check-implementation-readiness (Stub)
...
```
Read and follow all instructions in: bmad.lens.release/.github/prompts/bmad-bmm-check-implementation-readiness.prompt.md
```
