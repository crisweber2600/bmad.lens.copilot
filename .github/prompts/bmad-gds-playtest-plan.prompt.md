````prompt
---
description: 'Playtest Plan'
---

# bmad-gds-playtest-plan (Stub)
...
```
Read and follow all instructions in: bmad.lens.release/.github/prompts/bmad-gds-playtest-plan.prompt.md
```
